...
To get this running locally you'll need Python 3.x and pip installed. The use of virtualenv is also highly encouraged even though the software doesn't care. First install the dependencies (1) and then duplicate (2) and fill in the config file if you wish to run on a custom host and port. 
